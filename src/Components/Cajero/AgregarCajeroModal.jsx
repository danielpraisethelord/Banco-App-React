...
export const AgregarCajeroModal = ({isVisible, onClose, onAddSucess}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const cajero = {
                ...
                transacciones : null,
                cajaAsignada,
                numeroTransacciones : null
            };
            const response = await CajeroService.create(cajero, token);
            console.log('Cajero agregado:', response);
            onAddSucess();
            onClose();
        } catch (error) {
